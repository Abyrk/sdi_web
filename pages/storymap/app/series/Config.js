define([],
	function ()
	{
		configOptions = {
			...
			webmaps: [
			{
				id: "afd7aefb03c542a9978e3fd9f4ef3232",
				title: "",
				...
				id: "a66add065ec44f078c3810c7203e7dd4",
				title: "",
				// If your map has time properties, choose to show a single time instance instead of the time interval saved with the web map.
				showSingleTimeInstance: false,
				// Hide legend and legend toggle for specific map by setting this option to false
			...
			{
				id: "04b97b5b7b87436f8ebc3f9e0cdaa3b6",
				title: "",
				// If your map has time properties, choose to show a single time instance instead of the time interval saved with the web map.
				showSingleTimeInstance: false,
				// Hide legend and legend toggle for specific map by setting this option to false
				...
				id: "0604b54255bd44ecb89bcb9e19b98e79",
				title: "",
				// If your map has time properties, choose to show a single time instance instead of the time interval saved with the web map.
				showSingleTimeInstance: false,
			  // Hide legend and legend toggle for specific map by setting this option to false
			...
			title: "Landscape of the Isle of Wight",
			//Enter a subtitle, if no subtitle is specified, the first webmap's subtitle is used.
			subtitle: "Formed of sedimentary rocks, the Isle is rich in fossils and even dinosaur bones.",
